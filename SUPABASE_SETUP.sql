-- ============================================================================
-- تطبيق الشاطر للطباعة والقرطاسية - إعدادات Supabase
-- ============================================================================
...
-- ============================================================================
-- 3. إنشاء دالة لحساب التسعير (PostgreSQL Function)
-- ============================================================================
...
-- ============================================================================
-- 4. إنشاء دالة لتحديث حالة الطلب وإرسال إشعار
-- ============================================================================
...
BEGIN
  ...
  -- إدراج الإشعار في جدول الإشعارات (إذا كان موجوداً)
  INSERT INTO public.notifications (user_id, order_id, message, type, created_at)
  VALUES (v_order.user_id, p_order_id, v_notification_msg, 'order_status', NOW())
...
CREATE TABLE IF NOT EXISTS public.pricing_history (
  ...
  changed_by uuid REFERENCES public.auth.users(id),
...
-- ============================================================================
-- 12. تعديل جدول الطلبات لإضافة أعمدة إضافية (إذا لزم)
-- ============================================================================
