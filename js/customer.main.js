...
async function init() {
  ...
  // إظهار هدية أول طلب (بعد إنهاء onboarding فقط)
  const user = customerState.get('user');
  if (!user.first_order_done && localStorage.getItem(Config.APP.STORAGE_KEYS.ONBOARDING_DONE) === '1') {
